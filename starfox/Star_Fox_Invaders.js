...
function draw() {
 ...
 //appearance of world
  ...
  function preload(){
    playerImage = loadImage('https://star-lullaby.github.io/starfox/arwing_up.png');
    alienImage = loadImage('https://star-lullaby.github.io/starfox/alien.png');
  //fonts 
    titleFont = loadFont('https://star-lullaby.github.io/starfox/minecraft.ttf');
    bodyFont = loadFont('https://star-lullaby.github.io/starfox/minecraft.ttf');
  //sounds
    fireSound = loadSound('https://star-lullaby.github.io/starfox/lazer.wav');
    explosionSound = loadSound('https://star-lullaby.github.io/starfox/lazer_hit.wav');
    backgroundMusic = loadSound('https://star-lullaby.github.io/starfox/corneria.mp3');
